...
export const metadata = {
  ...
  twitter: { card: 'summary' as const, title: 'Request a Lawn Care or Landscaping Quote | Cavalry Green LLC', description: 'Request lawn care, landscaping, cleanup, and maintenance services in Hope Mills, Fayetteville, Raeford, Spring Lake and Cameron, NC.' },
};
