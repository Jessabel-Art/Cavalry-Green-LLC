...
export const metadata = {
  ...
  twitter: { card: 'summary' as const, title: 'Lawn Care & Landscaping in Hope Mills, NC | Cavalry Green LLC', description: 'Reliable lawn care, landscaping, property cleanups and recurring property maintenance in Hope Mills, Fayetteville, Raeford, Spring Lake and Cameron, NC.' },
};

export default function Home() {
  return <><Header /><main id="main-content">
    <section className="hero">
      <div className="hero-photo"><Image src="/hero-lawn.png" alt="Lawn care professional mowing a residential front yard" fill priority sizes="(max-width: 960px) 100vw, 57vw" /></div>
    ...
    <section className="veteran-story"><div className="story-photo"><Image src="/service-landscape.png" alt="Freshly maintained planting bed and lawn at a residential property" fill sizes="(max-width: 850px) 100vw, 58vw" /></div><div className="story-copy"><p className="eyebrow">A service mindset</p><h2>Veteran owned.<br /><em>Community focused.</em></h2><p>Discipline, reliability, attention to detail, and respect for your property guide every job. Cavalry Green brings that steady service mindset to homes and properties throughout the communities we serve.</p></div></section>
