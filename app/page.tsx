...
export default function Home() {
  return <><Header /><main id="main-content">
    <section className="hero">
      <div className="hero-photo"><Image src="/hero-lawn.webp" alt="Maintained residential lawn and landscaped planting beds" fill priority sizes="(max-width: 960px) 100vw, 57vw" /></div>
    ...
    <section className="veteran-story"><div className="story-photo"><Image src="/service-landscape.webp" alt="Freshly maintained planting bed and lawn at a residential property" fill sizes="(max-width: 850px) 100vw, 58vw" /></div><div className="story-copy"><p className="eyebrow">A service mindset</p><h2>Veteran owned.<br /><em>Community focused.</em></h2><p>Discipline, reliability, attention to detail, and respect for your property guide every job. Cavalry Green brings that steady service mindset to homes and properties throughout the communities we serve.</p></div></section>
