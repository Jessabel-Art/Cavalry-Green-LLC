...
export default function Services() {
  const imageData = [
    {src:'/service-landscape.webp',alt:'Lawn edging beside a mulched planting bed and walkway'},
    {src:'/service-cleanup.webp',alt:'Branches, leaves and bagged yard debris gathered beside a driveway'},
    {src:'/service-hauling.webp',alt:'Utility trailer loaded with furniture and household items for hauling'},
  ];
