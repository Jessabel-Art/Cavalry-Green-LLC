...
export const metadata = {
  ...
  twitter: { card: 'summary' as const, title: 'Lawn Care & Landscaping Services | Cavalry Green LLC', description: 'Explore lawn care, landscaping, cleanup and recurring maintenance from Cavalry Green LLC.' },
};
